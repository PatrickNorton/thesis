...
whether any problem that can be solved quickly can also be verified quickly.
...
Probabilistically-checkable proofs are another model, and one that we will be
looking at quite a lot. Here, instead of a verifier that responds to our
...
answer them correctly, then it must be the case that the prover has proven the
statement.
