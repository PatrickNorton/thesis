...
This is a relatively straightforward result; we put it here to ``cover all our
bases'', so to speak. From this, we can gather that our relativization results
will be differentiating cases where $\P^{A} = \NP^{A}$ and $\P^{A} \subsetneq \NP^{A}$.
