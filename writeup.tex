...
\begin{defn}[{\cite[Def.\ 4.2.1]{Go01}}]\label{def:interactive-tm}\index{Turing machine!interactive}
  An \emph{interactive Turing machine} is
\end{defn}
...
\begin{defn}[{\cite[Def.\ 4.2.4]{Go01}}]\label{def:ips}\index{interactive proof!single-prover}
  An \emph{interactive proof system} is
\end{defn}
...
% TODO: Find citations
\begin{defn}\label{def:mps}\index{interactive proof!multi-prover}
  A \emph{multi-prover interactive proof system} is
\end{defn}
...
\begin{defn}\label{def:zero-knowledge}\index{perfect zero-knowledge}
  A proof system is \emph{perfect zero-knowledge} if
\end{defn}

\begin{defn}\label{def:pzk}\index{PZK@$\PZK$}
  The class $\PZK$ is
\end{defn}

\section{Probabilistically-checkable proofs}\label{sec:pcp}

\begin{defn}\label{def:prob-check}\index{probabilistically-checkable proof}
  A \emph{probabilistically-checkable proof} is
\end{defn}

\begin{defn}\label{def:pcp}\index{PCP@$\PCP$}
  The class $\PCP$ is
\end{defn}
