...
\begin{defn}[{\cite[\defaultS 1.1]{KR08}}]\label{defn:ipcp}\index{interactive PCP}
  An \emph{interactive PCP} is % TODO
\end{defn}

\begin{defn}\label{defn:ipcp-class}\index{IPCP@$\mathsf{IPCP}$}
  The class $\mathsf{IPCP}$ is % TODO
\end{defn}
