...
\begin{thm}\label{thm:gni-pzk-ip}
  The language $\GNI$ has a perfect zero-knowledge interactive proof.
\end{thm}
...
\begin{algorithm}[htbp]
  ...
  \KwOut{Whether $G_{0} \ncong G_{1}$}
  \TODO{}\;
  \caption{A perfect zero-knowledge IP for $\GNI$}\label{alg:gni-pzk-ip}
\end{algorithm}
...
\begin{thm}[{\cite[Theorem 2.1.9]{ALMSS98}}]\index{thm:always-robust-pcpp}
...
\begin{thm}[{\cite[Prop.\ 2.14]{BGHSV06}}]\index{thm:parallel-vs-robust}
  % TODO
\end{thm}
